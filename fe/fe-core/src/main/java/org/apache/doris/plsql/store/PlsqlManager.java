...
package org.apache.doris.plsql.store;
...
public class PlsqlManager implements Writable {
    ...
    Map<StoredKey, PlsqlPackage> nameToPackages = Maps.newConcurrentMap();
    ...
    public PlsqlPackage getPackage(StoredKey storedKey) {
    ...
    public void replayAddPackage(PlsqlPackage pkg) {
        StoredKey storedKey = new StoredKey(pkg.getName(), pkg.getCatalogName(), pkg.getDbName());
        nameToPackages.put(storedKey, pkg);
