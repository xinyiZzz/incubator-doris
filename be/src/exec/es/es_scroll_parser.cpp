    ...
    for (int i = 0; i < tuple_desc->slots().size(); ++i) {
        ...
        if (slot_desc->col_name() == FIELD_ID) {
            ...
            if (UNLIKELY(buffer == nullptr)) {
                ...
                RETURN_LIMIT_EXCEEDED(tls_ctx()->_thread_mem_tracker_mgr->limiter_mem_tracker(), nullptr, details, len, rst);
            }
        ...
        case TYPE_STRING: {
            ...
            if (UNLIKELY(buffer == nullptr)) {
                ...
                RETURN_LIMIT_EXCEEDED(tls_ctx()->_thread_mem_tracker_mgr->limiter_mem_tracker(), nullptr, details, val_size, rst);
            }
