...
// https://github.com/apache/impala/blob/branch-2.9.0/be/src/runtime/data-stream-recvr.cc
...
private:
    ...
    // is retrieved.
    unique_ptr<RowBatch> _current_batch;
...
DataStreamRecvr::DataStreamRecvr(
    ...
    _mem_tracker = std::make_unique<MemTracker>( "DataStreamRecvr", _profile);
