...
LoadChannel::~LoadChannel() {
    ...
    _mem_tracker->consume_local(-_mem_tracker->consumption(), MemTrackerLimiter::get_process_tracker_limiter());
}

Status LoadChannel::open(const PTabletWriterOpenRequest& params) {
    SCOPED_THREAD_ATTACH_LIMITER_MEM_TRACKER(ThreadContext::TaskType::LOAD, _mem_tracker);
