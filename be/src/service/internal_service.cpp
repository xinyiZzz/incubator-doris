...
void PInternalServiceImpl::transmit_data(google::protobuf::RpcController* cntl_base,
    ...
    _transmit_data(cntl_base, request, response, done);
}
...
void PInternalServiceImpl::transmit_data_by_http(google::protobuf::RpcController* cntl_base,
    ...
    _transmit_data(cntl_base, request_raw, response, done);
}
...
void PInternalServiceImpl::tablet_writer_add_block_by_http(google::protobuf::RpcController* cntl_base,
                                                   const ::doris::PEchoRequest* request,
                                                   PTabletWriterAddBlockResult* response,
                                                   google::protobuf::Closure* done) {
    PTabletWriterAddBlockRequest* request_raw = new PTabletWriterAddBlockRequest();
    brpc::Controller* cntl = static_cast<brpc::Controller*>(cntl_base);
    attachment_extract_request_contain_block<PTabletWriterAddBlockRequest>(request_raw, cntl);
    _tablet_writer_add_block(cntl_base, request_raw, response, done);
}
...
void PInternalServiceImpl::tablet_writer_add_batch_by_http(google::protobuf::RpcController* cntl_base,
                                                   const ::doris::PEchoRequest* request,
                                                   PTabletWriterAddBatchResult* response,
                                                   google::protobuf::Closure* done) {
    PTabletWriterAddBatchRequest* request_raw = new PTabletWriterAddBatchRequest();
    brpc::Controller* cntl = static_cast<brpc::Controller*>(cntl_base);
    attachment_extract_request_contain_row_batch<PTabletWriterAddBatchRequest>(request_raw, cntl);
...
void PInternalServiceImpl::transmit_block(google::protobuf::RpcController* cntl_base,
                                          ...
                                          google::protobuf::Closure* done) {
    SCOPED_SWITCH_BTHREAD();
    _transmit_block(cntl_base, request, response, done);
}
...
void PInternalServiceImpl::transmit_block_by_http(google::protobuf::RpcController* cntl_base,
    ...
    _transmit_block(cntl_base, request_raw, response, done);
}
