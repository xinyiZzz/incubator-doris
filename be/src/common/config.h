...
// Whether to embed the ProtoBuf Request serialized string together with RowBatch/Block data into
// Controller Attachment and send it through http brpc when the ProtoBuf Request length exceeds 2G.
// This is to avoid the error of Request length overflow (2G).
CONF_mBool(brpc_request_embed_attachment_send_by_http, "false");
