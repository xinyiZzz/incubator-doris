...
StorageEngine::StorageEngine(const EngineOptions& options)
        : _options(options),
          ...
          _compaction_mem_tracker(
                  MemTrackerLimiter::create_tracker(-1, "StorageEngine::AutoCompaction")),
          _tablet_mem_tracker(MemTrackerLimiter::create_tracker(-1, "StorageEngine::TabletHeader")),
          _schema_change_mem_tracker(
                  MemTrackerLimiter::create_tracker(-1, "StorageEngine::SchemaChange")),
          _storage_migration_mem_tracker(
                  MemTrackerLimiter::create_tracker(-1, "StorageEngine::StorageMigration")),
          _clone_mem_tracker(MemTrackerLimiter::create_tracker(-1, "StorageEngine::Clone")),
          _batch_load_mem_tracker(
                  MemTrackerLimiter::create_tracker(-1, "StorageEngine::BatchLoad")),
          _consistency_mem_tracker(
                  MemTrackerLimiter::create_tracker(-1, "StorageEngine::Consistency")),
