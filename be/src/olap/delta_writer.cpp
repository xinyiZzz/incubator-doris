...
Status DeltaWriter::init() {
    ...
    _flushed_mem_tracker = MemTracker::create_tracker(fmt::format("DeltaWriter:tabletId={}", std::to_string(_tablet->tablet_id())))
...
void DeltaWriter::_reset_mem_table() {
    _mem_table.reset(new MemTable(_tablet->tablet_id(), _schema.get(), _tablet_schema.get(),
                                  ...
                                  _rowset_writer.get(), _flushed_mem_tracker, _is_vec));
}
